...
alert(`Rules:
  1.Roll the die (use 'r').
  2. If you get "1" your chance to hold and the accumulated score will be lost. 
  3. Hold your score to store the value and pass the chance (use 'h').
  4. First Person to reach 100 will win the game`);
function init() {
  current = 0;
  activePlayer = 0;
  scores = [0, 0];
